-- Sauvegarde générée le 2026-01-19 07:07:03
...
CREATE TABLE `actes_medicaux` (
  ...
  `code_acte` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom_acte` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `code_ccam` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `code_cim` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `administrations_medicaments` (
  ...
  `unite_quantite` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `voie_administration` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `site_injection` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `observations` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `effet_secondaire_observe` tinyint(1) DEFAULT '0',
  `description_effet_secondaire` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `admissions` (
  ...
  `numero_admission` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_admission` datetime NOT NULL,
  `date_sortie` datetime DEFAULT NULL,
  `type_admission` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Programmée, Urgence, Transfert',
  `motif_admission` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `diagnostic_principal` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `diagnostic_secondaire` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `medecin_sortie_id` int DEFAULT NULL,
  `raison_sortie` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Guérison, Décès, Transfert, Départ volontaire',
  `notes_sortie` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Admis, Hospitalisé, Sortie, Décédé',
...
CREATE TABLE `archives` (
  ...
  `hopital_id` int NOT NULL,
  `patient_id` int NOT NULL,
  `numero_archive` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_archivage` datetime NOT NULL,
  `type_archivage` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Dossier complet, Dossier partiel, Documents',
  `raison_archivage` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Fin de traitement, Décès, Transfert, Inactivité',
  `localisation_archive` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `support_archive` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Physique, Numérique, Hybride',
  `duree_conservation` int DEFAULT NULL COMMENT 'En années',
  `date_destruction_prevue` date DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Archivé, En attente destruction, Détruit',
...
CREATE TABLE `assurances_patients` (
  ...
  `numero_police` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_debut` date DEFAULT NULL,
  `date_fin` date DEFAULT NULL,
  `beneficiaire_nom` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `beneficiaire_lien` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `audit_trail` (
  ...
  `action_type` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'UPDATE',
  `entite_type` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  KEY `idx_audit_hopital` (`hopital_id`),
...
CREATE TABLE `backup_schedules` (
  ...
  `hopital_id` int NOT NULL,
  `utilisateur_id` int NOT NULL,
  `schedule_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type_backup` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'COMPLETE',
  `frequency` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'DAILY',
  `time` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '02:00',
  `day_of_week` int DEFAULT NULL,
  `day_of_month` int DEFAULT NULL,
  `localisation_backup` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `localisation_secondaire` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `dernier_statut` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `message_erreur` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `bons_commande` (
  ...
  `numero_bon` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `devise_id` int DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Brouillon, Validée, Commandée, Livrée, Facturée, Annulée',
  `notes_commande` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `bulletins_paie` (
  ...
  `utilisateur_id` int NOT NULL,
  `hopital_id` int NOT NULL,
  `numero_bulletin` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `devise_id` int DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Brouillon, Validé, Payé',
...
CREATE TABLE `certifications` (
  ...
  `utilisateur_id` int NOT NULL,
  `hopital_id` int NOT NULL,
  `nom_certification` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `organisme_certification` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_obtention` date NOT NULL,
  `date_expiration` date DEFAULT NULL,
  `numero_certification` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Valide, Expiré, Suspendu',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `utilisateur_id` (`utilisateur_id`),
...
CREATE TABLE `chambres` (
  ...
  `service_id` int NOT NULL,
  `hopital_id` int NOT NULL,
  `numero_chambre` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `etage` int DEFAULT NULL,
  `nombre_lits` int DEFAULT NULL,
  `type_chambre` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `comptes_portail_patient` (
  ...
  `patient_id` int NOT NULL,
  `hopital_id` int NOT NULL,
  `email_portail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `mot_de_passe_portail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `conges` (
  ...
  `utilisateur_id` int NOT NULL,
  `hopital_id` int NOT NULL,
  `type_conge` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Annuel, Maladie, Maternité, Paternité, Autre',
  `date_debut` date NOT NULL,
  `date_fin` date NOT NULL,
  `nombre_jours` int DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Demandé, Approuvé, Rejeté, En cours, Terminé',
...
CREATE TABLE `consentements_recherche` (
  ...
  `signature_patient` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `signature_temoin` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_retrait_consentement` date DEFAULT NULL,
  `raison_retrait` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `consultations` (
  ...
  `motif_consultation` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `diagnostic_principal` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `diagnostic_secondaire` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `plan_traitement` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `observations_cliniques` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `examen_physique` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `tension_arterielle` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `frequence_cardiaque` int DEFAULT NULL,
  `temperature` decimal(4,1) DEFAULT NULL,
  `poids` decimal(6,2) DEFAULT NULL,
  `taille` decimal(5,2) DEFAULT NULL,
  `imc` decimal(5,2) DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Complétée, Brouillon, Annulée',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_patient` (`patient_id`),
...
CREATE TABLE `contrats` (
  ...
  `utilisateur_id` int NOT NULL,
  `hopital_id` int NOT NULL,
  `numero_contrat` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type_contrat` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'CDI, CDD, Stage, Consultant',
  `date_debut` date NOT NULL,
  `date_fin` date DEFAULT NULL,
  `poste` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `salaire_base` decimal(12,2) DEFAULT NULL,
  `devise_id` int DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Actif, Suspendu, Terminé',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `contrats_maintenance` (
  ...
  `fournisseur_id` int NOT NULL,
  `numero_contrat` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type_maintenance` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Préventive, Corrective, Mixte',
  `date_debut` date NOT NULL,
  `date_fin` date DEFAULT NULL,
  `frequence_maintenance` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Mensuelle, Trimestrielle, Annuelle',
  `cout_maintenance` decimal(12,2) DEFAULT NULL,
  `devise_id` int DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Actif, Expiré, Suspendu',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_hopital_contrat` (`hopital_id`,`numero_contrat`),
...
CREATE TABLE `conventions_assurance` (
  ...
  `type_couverture` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Assurance, Mutuelle, Privé',
  `pourcentage_couverture` decimal(5,2) DEFAULT NULL,
  `contact_personne` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `numero_convention` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `creneaux_consultation` (
  ...
  `type_consultation` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Consultation, Suivi, Urgence',
...
CREATE TABLE `demandes_interventions` (
  ...
  `diagnostic_preoperatoire` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `antecedents_chirurgicaux` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `medicaments_actuels` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `allergies` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Brouillon, Validée, Programmée, Réalisée, Annul��e',
  `date_intervention_prevue` date DEFAULT NULL,
  `notes_demande` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `devises` (
  ...
  `symbole` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `distributions_pharmacie` (
  ...
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Brouillon, Validée, Distribuée, Reçue',
...
INSERT INTO `doctrine_migration_versions` (`version`, `executed_at`, `execution_time`) VALUES ('DoctrineMigrations\\Version20260118EnhanceLogsAudit', '2026-01-19 06:21:33', '569');
INSERT INTO `doctrine_migration_versions` (`version`, `executed_at`, `execution_time`) VALUES ('DoctrineMigrations\\Version20260119AddMissingFieldsToLogsAudit', '2026-01-19 06:23:24', '191');
INSERT INTO `doctrine_migration_versions` (`version`, `executed_at`, `execution_time`) VALUES ('DoctrineMigrations\\Version20260119CreateAuditTrailTable', '2026-01-19 06:21:33', '118');
...
CREATE TABLE `documents` (
  ...
  `utilisateur_id` int DEFAULT NULL,
  `type_document` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ordonnance, Rapport, Certificat, Feuille de sortie, etc.',
  ...
  `type_fichier` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `taille_fichier` int DEFAULT NULL COMMENT 'En octets',
  `date_document` date DEFAULT NULL,
  `date_expiration` date DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Brouillon, Validé, Signé, Archivé',
  `confidentialite` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Public, Confidentiel, Très confidentiel',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_hopital` (`hopital_id`),
...
CREATE TABLE `dossiers_medicaux` (
  ...
  `patient_id` int NOT NULL,
  `hopital_id` int NOT NULL,
  `numero_dme` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_ouverture` date NOT NULL,
  `date_fermeture` date DEFAULT NULL,
  `medecin_referent_id` int DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Actif, Archivé, Suspendu',
  `notes_generales` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `equipements` (
  ...
  `code_equipement` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom_equipement` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type_equipement` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Biomédical, Informatique, Mobilier, etc.',
  ...
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Actif, Maintenance, Hors service, Retiré',
  `localisation` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `equipes_chirurgicales` (
  ...
  `utilisateur_id` int NOT NULL,
  `role_equipe` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Chirurgien, Assistant, Anesthésiste, Infirmier, etc.',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `examens_imagerie` (
  ...
  `patient_id` int NOT NULL,
  `hopital_id` int NOT NULL,
  `numero_examen` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_examen` datetime NOT NULL,
  `technicien_id` int NOT NULL,
  `modalite` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `zone_anatomique` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `observations_technique` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Programmé, En cours, Complété, Rejeté',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `exports_rapports` (
  ...
  `hopital_id` int NOT NULL,
  `utilisateur_id` int NOT NULL,
  `format_export` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'PDF, CSV, Excel, JSON',
  `chemin_fichier` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nom_fichier` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `taille_fichier` int DEFAULT NULL COMMENT 'En octets',
  `date_export` datetime NOT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Généré, Téléchargé, Expiré',
...
CREATE TABLE `factures` (
  ...
  `devise_id` int DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Brouillon, Validée, Envoyée, Payée, Partiellement payée, Impayée',
  `type_facture` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Consultation, Hospitalisation, Acte, Autre',
  `notes_facture` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `feuilles_sortie` (
  ...
  `hopital_id` int NOT NULL,
  `medecin_id` int NOT NULL,
  `numero_feuille` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_sortie` date NOT NULL,
  `diagnostic_principal` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `diagnostic_secondaire` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `procedures_effectuees` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `medicaments_sortie` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `recommandations_sortie` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `suivi_recommande` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_prochain_rendez_vous` date DEFAULT NULL,
  `medecin_suivi_id` int DEFAULT NULL,
  `restrictions_activites` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `regime_alimentaire` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `soins_plaies` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `signes_alerte` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `fichiers_dicom` (
  ...
  `hopital_id` int NOT NULL,
  `numero_serie` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_instance` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `chemin_fichier` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nom_fichier` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `taille_fichier` int DEFAULT NULL COMMENT 'En octets',
  `format_fichier` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_creation_dicom` datetime DEFAULT NULL,
  `date_archivage` datetime DEFAULT NULL,
  `localisation_pacs` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `formations` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hopital_id` int NOT NULL,
  `code_formation` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom_formation` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `type_formation` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Interne, Externe, E-learning',
  `date_debut` date DEFAULT NULL,
  `date_fin` date DEFAULT NULL,
  `formateur` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nombre_heures` int DEFAULT NULL,
  `lieu_formation` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `fournisseurs` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hopital_id` int NOT NULL,
  `code_fournisseur` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom_fournisseur` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type_fournisseur` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Pharmacie, Équipement, Consommables, etc.',
  ...
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contact_personne` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_siret` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_tva` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `conditions_paiement` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `delai_livraison` int DEFAULT NULL COMMENT 'En jours',
  `logo_fournisseur` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `actif` tinyint(1) DEFAULT '1',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `hopitaux` (
  ...
  `type_hopital` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Public, Privé, Clinique',
  `nombre_lits` int DEFAULT NULL,
  `logo_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `icone_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `couleur_primaire` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `couleur_secondaire` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `indicateurs_qualite` (
  ...
  `hopital_id` int NOT NULL,
  `service_id` int DEFAULT NULL,
  `code_indicateur` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom_indicateur` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `type_indicateur` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Infection, Mortalité, Réadmission, Satisfaction, etc.',
  `unite_mesure` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `valeur_cible` decimal(10,2) DEFAULT NULL,
  `frequence_mesure` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Quotidienne, Hebdomadaire, Mensuelle',
  `date_debut` date DEFAULT NULL,
  `date_fin` date DEFAULT NULL,
  `actif` tinyint(1) DEFAULT '1',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `integrations_externes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hopital_id` int NOT NULL,
  `code_integration` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom_integration` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type_integration` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'HL7, FHIR, API REST, SFTP, etc.',
  `url_endpoint` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `authentification_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'API Key, OAuth2, Basic Auth',
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Active, Inactive, Erreur',
  `derniere_synchronisation` datetime DEFAULT NULL,
  `frequence_synchronisation` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `interactions_medicamenteuses` (
  ...
  `niveau_severite` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Légère, Modérée, Grave, Contre-indication',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `recommandation` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `interventions_maintenance` (
  ...
  `equipement_id` int NOT NULL,
  `hopital_id` int NOT NULL,
  `numero_intervention` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_intervention` date NOT NULL,
  `type_intervention` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Préventive, Corrective, Inspection',
  `technicien_id` int NOT NULL,
  `description_intervention` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `pieces_remplacees` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `duree_intervention` int DEFAULT NULL COMMENT 'En heures',
  `cout_intervention` decimal(12,2) DEFAULT NULL,
  `devise_id` int DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Programmée, En cours, Complétée, Annulée',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `lignes_bons_commande` (
  ...
  `description_article` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `lignes_distributions` (
  ...
  `quantite` int NOT NULL,
  `lot_numero` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_expiration` date DEFAULT NULL,
  `prix_unitaire` decimal(10,2) DEFAULT NULL,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `lignes_factures` (
  ...
  `description_ligne` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `lignes_ordonnances_imagerie` (
  ...
  `imagerie_id` int NOT NULL,
  `quantite` int DEFAULT '1',
  `priorite` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Routine, Urgent',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `lignes_prescriptions` (
  ...
  `frequence_administration` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '1x/jour, 2x/jour, etc.',
  `voie_administration` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Orale, IV, IM, SC, etc.',
  `duree_traitement` int DEFAULT NULL COMMENT 'En jours',
  `instructions_speciales` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `lits` (
  ...
  `hopital_id` int NOT NULL,
  `numero_lit` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type_lit` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Standard, Semi-privé, Privé, Soins intensifs',
  `etage` int DEFAULT NULL,
  `chambre` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Disponible, Occupé, Maintenance, Fermé',
...
CREATE TABLE `logs_audit` (
  ...
  `entite` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `entite_id` int DEFAULT NULL,
  `ancienne_valeur` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `nouvelle_valeur` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `adresse_ip` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_agent` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `type_log` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'TECHNIQUE',
  `niveau` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `statut` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `message_erreur` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `signature` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `alerte` tinyint(1) DEFAULT NULL,
  `type_alerte` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `idx_type_log_date` (`type_log`,`date_creation`),
  KEY `idx_niveau_date` (`niveau`,`date_creation`),
  KEY `idx_categorie_date` (`categorie`,`date_creation`),
  KEY `idx_action_type_date` (`action_type`,`date_creation`),
  KEY `idx_statut_date` (`statut`,`date_creation`),
  KEY `idx_entite_type_id` (`entite_type`,`entite_id`),
  KEY `idx_utilisateur_date` (`utilisateur_id`,`date_creation`),
  KEY `idx_hopital_date` (`hopital_id`,`date_creation`),
  KEY `idx_code_http` (`code_http`),
...
CREATE TABLE `logs_integrations` (
  ...
  `type_log` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Info, Avertissement, Erreur',
  `message_log` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `donnees_envoyees` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `donnees_recues` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `medicaments` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code_medicament` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom_commercial` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom_generique` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `forme_pharmaceutique` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Comprimé, Injection, Sirop, etc.',
  `dosage` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unite_dosage` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fabricant` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `code_atc` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `code_cip` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prix_unitaire` decimal(10,2) DEFAULT NULL,
  `devise_id` int DEFAULT NULL,
  `taux_tva_id` int DEFAULT NULL,
  `actif` tinyint(1) DEFAULT '1',
...
CREATE TABLE `messages_securises` (
  ...
  `contenu_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type_message` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Consultation, Résultat, Rappel, Autre',
  `date_envoi` datetime NOT NULL,
  `date_lecture` datetime DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Envoyé, Lu, Répondu, Archivé',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_patient` (`patient_id`),
  KEY `idx_hopital` (`hopital_id`),
...
CREATE TABLE `mesures_indicateurs` (
  ...
  `notes_mesure` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `utilisateur_id` int DEFAULT NULL,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `modes_paiement` (
  ...
  `nom` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `type_paiement` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Espèces, Chèque, Carte, Virement, Assurance, Autre',
...
CREATE TABLE `mouvements_stock` (
  ...
  `type_mouvement` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Entrée, Sortie, Ajustement, Perte',
  `quantite` int NOT NULL,
  `motif` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `utilisateur_id` int DEFAULT NULL,
  `reference_document` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `niveaux_triage` (
  ...
  `icone` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `notes_infirmieres` (
  ...
  `type_note` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Observation, Ronde, Incident, Alerte',
  `contenu` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `signes_vitaux_tension` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `observations_generales` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_admission` (`admission_id`),
...
CREATE TABLE `notifications` (
  ...
  `hopital_id` int NOT NULL,
  `utilisateur_id` int NOT NULL,
  `type_notification` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Alerte, Rappel, Information, Urgence',
  `titre_notification` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contenu_notification` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `priorite` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Basse, Normale, Haute, Critique',
  `date_notification` datetime NOT NULL,
  `date_lecture` datetime DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Non lue, Lue, Archivée',
...
CREATE TABLE `ordonnances_imagerie` (
  ...
  `consultation_id` int DEFAULT NULL,
  `admission_id` int DEFAULT NULL,
  `numero_ordonnance` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_ordonnance` datetime NOT NULL,
  `motif_examen` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `urgence` tinyint(1) DEFAULT '0',
  `zone_anatomique` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `antecedents_pertinents` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Brouillon, Validée, Programmée, Réalisée, Rapportée, Annulée',
  `notes_ordonnance` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `ordonnances_labo` (
  ...
  `motif_examen` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `urgence` tinyint(1) DEFAULT '0',
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Brouillon, Validée, Reçue au labo, En cours, Complétée, Annulée',
  `notes_ordonnance` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `paiements` (
  ...
  `patient_id` int NOT NULL,
  `hopital_id` int NOT NULL,
  `numero_paiement` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Enregistré, Validé, Annulé',
  `notes_paiement` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `panels_examens` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code_panel` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom_panel` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `parametres_configuration` (
  ...
  `type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'string, int, boolean, json, decimal',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `categorie` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Général, Affichage, Paiement, Email, SMS, Sécurité, etc.',
  `logo_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `icone_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `couleur_primaire` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `couleur_secondaire` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `email_expediteur` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_support` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `telephone_support` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `url_logo_email` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `signature_email` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `actif` tinyint(1) DEFAULT '1',
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `participations_formations` (
  ...
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Inscrit, Participé, Absent, Complété',
...
CREATE TABLE `patients` (
  ...
  `sexe` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'M ou F',
  `numero_identite` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type_identite` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'CNI, Passeport, Permis',
  `adresse` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ville` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `code_postal` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `telephone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `contact_urgence_telephone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contact_urgence_lien` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `groupe_sanguin` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `allergies` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `antecedents_medicaux` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `antecedents_chirurgicaux` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `medicaments_actuels` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `statut_civil` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Célibataire, Marié, Divorcé, Veuf',
  ...
  `langue_preference` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `photo_patient` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `actif` tinyint(1) DEFAULT '1',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `antecedents_familiaux_pere` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Antécédents médicaux du père',
  `antecedents_familiaux_mere` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Antécédents médicaux de la mère',
  `antecedents_familiaux_enfants` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Antécédents médicaux des enfants',
  `antecedents_familiaux_epouse` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Antécédents médicaux du conjoint/conjointe',
  `antecedents_familiaux_autres` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Autres antécédents familiaux pertinents',
  `historique_vaccinations` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Historique complet des vaccinations (JSON format)',
  `date_derniere_vaccination` date DEFAULT NULL COMMENT 'Date de la dernière vaccination',
  `habitudes_vie` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Tabagisme, alcool, drogues, etc.',
  `facteurs_risque` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Facteurs de risque identifiés',
  `observations_generales` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Observations générales du dossier médical',
...
CREATE TABLE `plaintes_incidents` (
  ...
  `patient_id` int DEFAULT NULL,
  `utilisateur_id` int DEFAULT NULL,
  `numero_plainte` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_plainte` datetime NOT NULL,
  `type_plainte` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Clinique, Administrative, Qualité, Sécurité',
  `description_plainte` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `gravite` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Mineure, Modérée, Grave, Critique',
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ouverte, En investigation, Résolue, Fermée',
  `responsable_investigation_id` int DEFAULT NULL,
  `date_resolution` datetime DEFAULT NULL,
  `actions_correctives` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `planning_operatoire` (
  ...
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Programmée, En cours, Complétée, Annulée, Reportée',
  `raison_annulation` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `poles_activite` (
  ...
  `nom` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `type_pole` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `prelevements` (
  ...
  `patient_id` int NOT NULL,
  `hopital_id` int NOT NULL,
  `numero_prelevement` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_prelevement` datetime NOT NULL,
  `infirmier_id` int NOT NULL,
  `type_specimen` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `volume_specimen` int DEFAULT NULL,
  `tube_prelevement` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_tube` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `conditions_conservation` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `observations_prelevement` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Prélevé, En transit, Reçu au labo, Rejeté',
  `date_reception_labo` datetime DEFAULT NULL,
  `raison_rejet` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `prescriptions` (
  ...
  `medecin_id` int NOT NULL,
  `hopital_id` int NOT NULL,
  `numero_prescription` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_prescription` datetime NOT NULL,
  `date_debut_traitement` date DEFAULT NULL,
  `date_fin_traitement` date DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Brouillon, Validée, Exécutée, Annulée',
  `notes_prescription` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `profils_utilisateurs` (
  ...
  `nom` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `type_profil` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Médecin, Infirmier, Admin, Pharmacien, Labo, Radiologue, RH, Finance, etc.',
  `icone` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `projets_recherche` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hopital_id` int NOT NULL,
  `code_projet` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `titre_projet` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description_projet` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `chercheur_principal_id` int NOT NULL,
  `date_debut` date NOT NULL,
  `date_fin` date DEFAULT NULL,
  `budget_projet` decimal(12,2) DEFAULT NULL,
  `devise_id` int DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Planifié, En cours, Suspendu, Complété, Annulé',
...
CREATE TABLE `rapports_operatoires` (
  ...
  `patient_id` int NOT NULL,
  `hopital_id` int NOT NULL,
  `numero_rapport` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_rapport` datetime NOT NULL,
  `chirurgien_id` int NOT NULL,
  `titre_intervention` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_intervention` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `complications` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `produits_utilises` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `specimens_preleves` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `recommandations_postop` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Brouillon, Validé, Signé, Archivé',
...
CREATE TABLE `rapports_personnalises` (
  ...
  `hopital_id` int NOT NULL,
  `utilisateur_id` int NOT NULL,
  `nom_rapport` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description_rapport` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `type_rapport` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Activité, Financier, Qualité, RH, etc.',
  `configuration_rapport` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'JSON avec paramètres du rapport',
  `frequence_generation` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Manuelle, Quotidienne, Hebdomadaire, Mensuelle',
  `date_derniere_generation` datetime DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Actif, Inactif',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_hopital` (`hopital_id`),
...
CREATE TABLE `rapports_radiologiques` (
  ...
  `titre_rapport` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contenu_rapport` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `conclusion` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `recommandations` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Brouillon, Validé, Signé, Archivé',
  `date_signature` datetime DEFAULT NULL,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `reclamations_assurance` (
  ...
  `convention_id` int NOT NULL,
  `hopital_id` int NOT NULL,
  `numero_reclamation` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_reclamation` date NOT NULL,
  `montant_reclame` decimal(12,2) DEFAULT NULL,
  `devise_id` int DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Soumise, En cours, Acceptée, Rejetée, Partiellement acceptée',
...
CREATE TABLE `rendez_vous` (
  ...
  `motif_consultation` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Programmé, Confirmé, Réalisé, Annulé, No-show',
  `type_consultation` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notes_pre_consultation` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `resultats_labo` (
  ...
  `examen_id` int NOT NULL,
  `valeur_resultat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unite_resultat` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `valeur_reference_min` decimal(10,2) DEFAULT NULL,
  `valeur_reference_max` decimal(10,2) DEFAULT NULL,
  `statut_resultat` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Normal, Anormal, Critique',
...
CREATE TABLE `salles_operations` (
  ...
  `type_salle` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Chirurgie générale, Orthopédie, Cardiologie, etc.',
  `capacite` int DEFAULT NULL,
  `equipements` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Disponible, Occupée, Maintenance, Fermée',
  `date_derniere_maintenance` date DEFAULT NULL,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `sauvegardes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hopital_id` int NOT NULL,
  `numero_sauvegarde` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_sauvegarde` datetime NOT NULL,
  `type_sauvegarde` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Complète, Incrémentale, Différentielle',
  `taille_sauvegarde` int DEFAULT NULL COMMENT 'En Mo',
  `localisation_sauvegarde` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'En cours, Complétée, Échouée',
  `duree_sauvegarde` int DEFAULT NULL COMMENT 'En secondes',
  `utilisateur_id` int DEFAULT NULL,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `backup_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type_backup` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'COMPLETE',
  `date_debut` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `date_fin` datetime DEFAULT NULL,
  `localisation_secondaire` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `checksum_sha256` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cle_chiffrement` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `compression` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `sauvegardes` (`id`, `hopital_id`, `numero_sauvegarde`, `date_sauvegarde`, `type_sauvegarde`, `taille_sauvegarde`, `localisation_sauvegarde`, `statut`, `duree_sauvegarde`, `utilisateur_id`, `date_creation`, `backup_id`, `type_backup`, `date_debut`, `date_fin`, `localisation_secondaire`, `checksum_sha256`, `cle_chiffrement`, `compression`, `nombre_fichiers`, `nombre_tables`, `date_expiration`, `message_erreur`, `notes`) VALUES ('11', '1', 'BKP-TEST-99be4a675c86d317-1768730066', '2026-01-18 11:54:26', NULL, '7323648', 'D:\\Amos\\projet\\rehoboth\\backups\\2026-01-18\\BKP-TEST-99be4a675c86d317-1768730066.sql', 'FAILED', '24', '1', '2026-01-18 11:54:26', 'BKP-TEST-99be4a675c86d317-1768730066', 'COMPLETE', '2026-01-18 11:54:26', NULL, NULL, 'aa34aeaa75b441d165b53e667c72624d4532e45e28b4bf3cdf103431c8fe76ac', NULL, 'GZIP', '495', '99', NULL, 'Erreur lors de la restauration: Warning: preg_match(): No ending delimiter \'/\' found', '{\"lastRestoreError\":\"Warning: preg_match(): No ending delimiter \'\\/\' found\",\"lastRestoreErrorAt\":\"2026-01-18T11:58:45+02:00\"}');
...
CREATE TABLE `services` (
  ...
  `nom` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `type_service` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Urgences, Chirurgie, Médecine, Pédiatrie, etc.',
  ...
  `telephone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `logo_service` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `couleur_service` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `actif` tinyint(1) DEFAULT '1',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `budget_annuel` decimal(12,2) DEFAULT NULL,
  `nombre_personnel` int DEFAULT NULL,
  `horaires_ouverture` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `niveau_accreditation` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `sessions_utilisateurs` (
  ...
  `utilisateur_id` int NOT NULL,
  `hopital_id` int NOT NULL,
  `token_session` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `adresse_ip` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_agent` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_connexion` datetime NOT NULL,
  `date_derniere_activite` datetime DEFAULT NULL,
  `date_deconnexion` datetime DEFAULT NULL,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Active, Expirée, Fermée',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `specialites` (
  ...
  `nom` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `code_snomed` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `icone` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `couleur` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `actif` tinyint(1) DEFAULT '1',
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `stocks_pharmacie` (
  ...
  `fournisseur_id` int DEFAULT NULL,
  `localisation_stockage` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `suivis_post_hospitalisation` (
  ...
  `type_suivi` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Téléphone, Visite, Consultation',
  `observations_suivi` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `complications_observees` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `adherence_traitement` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Bonne, Partielle, Mauvaise',
  `readmission_necessaire` tinyint(1) DEFAULT '0',
  `raison_readmission` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `tarifs_lits` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hopital_id` int NOT NULL,
  `type_lit` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `transferts_patients` (
  ...
  `motif_transfert` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `utilisateur_id` int DEFAULT NULL,
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `admission_id` (`admission_id`),
...
CREATE TABLE `triages` (
  ...
  `numero_triage` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `poids` decimal(6,2) DEFAULT NULL,
  `observations_triage` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `statut` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Triagé, En attente, Pris en charge, Transféré',
...
CREATE TABLE `types_examens_labo` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code_examen` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom_examen` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `code_loinc` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `code_snomed` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type_specimen` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Sang, Urine, Selles, etc.',
...
CREATE TABLE `types_imagerie` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code_imagerie` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom_imagerie` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `type_modalite` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Radiographie, Scanner, IRM, Échographie, etc.',
  `code_snomed` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prix_examen` decimal(10,2) DEFAULT NULL,
  `devise_id` int DEFAULT NULL,
  `taux_tva_id` int DEFAULT NULL,
...
CREATE TABLE `types_interventions` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code_intervention` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nom_intervention` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `code_ccam` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `duree_moyenne` int DEFAULT NULL COMMENT 'En minutes',
  `niveau_complexite` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Simple, Modérée, Complexe',
...
CREATE TABLE `utilisateurs` (
  ...
  `numero_licence` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_ordre` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_embauche` date DEFAULT NULL,
  `photo_profil` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `signature_numerique` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `nationalite` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_identite` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type_identite` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `date_creation` datetime DEFAULT CURRENT_TIMESTAMP,
  `date_modification` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `secret_2fa` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pin_2fa` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `adresse_physique` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_livraison` date DEFAULT NULL,
  `validite` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
